...
from ddht.typing import IDNonce
from ddht.v5.constants import ID_NONCE_SIGNATURE_PREFIX

v5_handshake_scheme_registry = HandshakeSchemeRegistry()
...
@v5_handshake_scheme_registry.register
class V4HandshakeScheme(BaseV4HandshakeScheme[SignatureInputs]):
    ...
    def create_id_nonce_signature_input(
        ...
        preimage = b"".join((ID_NONCE_SIGNATURE_PREFIX,) + signature_inputs)
