...
@pytest.mark.parametrize(
    ...
    (
        ...
        (
            ...
            decode_hex(
                "0x99978552079d428893703e74716071dff768eb7a911dcc4c6fd5a6e2f2a0d6da"
            ),
        ),
        (
            decode_hex(
                "0xf72d359a057d2c4dbb4502edd4b9ca5f71fe7f93357e733c5f18cadd754e30de"
            ),
            decode_hex(
                "0x4a0f699062a9871bd8ef06f94f51d338bba02aaaedefde860093ad5f1e64dc25"
            ),
            decode_hex(
                "0xa979df942382a64ea3ace81dd5ceb9d95c05ef3ef8e2515b4ab5e45638029b0a"
            ),
        ),
    ),
)
